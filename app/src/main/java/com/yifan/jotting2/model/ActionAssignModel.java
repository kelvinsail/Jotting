 ...
 */
public class ActionAssignModel extends DataHelper<ActionAssigns> {


    private static class ActionAssignsHelper {

        public static ActionAssignModel mInstance = new ActionAssignModel();

    }

    public static ActionAssignModel getInstance() {
        return ActionAssignsHelper.mInstance;
    }


    public ActionAssignModel() {
        super();
    }
